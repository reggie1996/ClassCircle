package doctorw.classcircle.utils.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = ClassCircleApplication.getmContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = ClassCircleApplication.getmContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
