...
public class ClassDongTai2Activity extends BaseActivity {

    private static final int TYPE_PHOTO = 101;
    private static final int TYPE_VEDIO = 102;
    private static final int TYPE_MOVIE = 103;
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_class_dong_tai2);
        mContent = this;
        mActivity = this;
    }
...
//        mDongTais = DatasUtil.initDongtai();
    ...
    private void requestDongtai() {
        ...
        Datas.loadClassDongtai(Urls.URL_LOADCLASSDT, mContent, params, new Datas.HandleResponse() {
            @Override
    ...
    protected void initListener() {
        ...
        ci_userphoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //传一个用户ID过去 点击自己的头像 所以可以直接获取
                Bundle bundle = new Bundle();
                bundle.putString("userid", SpUtils.getInstance().getString("userid",""));
                Intent intent = new Intent(mContent,SelfDongTaiActivity.class);
                intent.putExtras(bundle);
                startActivity(intent);
//                startActivity(SelfDongTaiActivity.class);
            }
        });
...
//                    Intent intent1 = new Intent(mContent, PublishCircleActivity.class);
                    startActivity(PublishCircleActivity.class);
//                    startActivityForResult(intent1, TYPE_DONGT);
                    break;

                case R.id.dropDown_item2:
//                    Intent intent2 = new Intent(mContent, PublishCircleActivity.class);
//                    startActivityForResult(intent2, TYPE_DONGT);
                    startActivity(PublishCircleVoiceActivity.class);
                    break;

                case R.id.dropDown_item3:

//                    Intent intent3 = new Intent(mContent, PublishCircleActivity.class);
//                    startActivityForResult(intent3, TYPE_DONGT);
                    startActivity(PublishCircleMovieActivity.class);
                    break;
                default:
                    break;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case TYPE_DONGT:
                ...
                DongTai dongtai = (DongTai) bundle.getSerializable("dongtai");
                mDongTais.add(0, dongtai);
