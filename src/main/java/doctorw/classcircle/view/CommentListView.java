...
import doctorw.classcircle.utils.UrlUtils;
import doctorw.classcircle.utils.spannable.CircleMovementMethod;
import doctorw.classcircle.utils.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        String id = bean.getUserNo();
        String toReplyName = "";
        if (bean.getToUserName()!= null) {
            toReplyName = bean.getToUserName();
        }

        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append(setClickableSpan(name, bean.getUserNo()));
//        builder.append(setClickableSpan(name, bean.getToUserName()));

        if (!TextUtils.isEmpty(toReplyName)) {
            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, bean.getToUserNo()));
        }
        builder.append(": ");
        //转换表情字符
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(ClassCircleApplication.getmContext(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
